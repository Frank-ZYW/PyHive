export default {
  ...
  messages: {
    ...
    cloning: '克隆中...',
    onFunction: '此功能暂不可用',
    selectUnavailable: '此选项不可用',
    deployNotice: '系统将选择已打包的最高版本部署',
    provideInterval: '请先设定运行时间间隔',
    withdrawFirst: '请先将项目反部署'
  },
  descriptions: {
